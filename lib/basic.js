...
Tema.prototype.setTheme = function (theme) {
  ...
  if (!_.isEmpty(this.defaultTheme)) {
    this.themeTree[0].parent = this.defaultTheme;
    this.themeTree.unshift(this.defaultTheme);
  }
...
Tema.prototype.findTemplate = function (options) {
  ...
  _.each(variables.templateSuggestions || [], function (suggestion) {
